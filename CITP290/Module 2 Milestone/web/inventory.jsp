...
<%@page import="Module2Milestone.InventoryManager"%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<jsp:useBean id = "inv" scope="application" class="Module2Milestone.InventoryServlet"></jsp:useBean>
<html>
    <head>
    ...
    <body>
        ...
        <c:forEach items="${inventory}" var="item">            
            ...
            <td>${item.getPrice()}</td>
            <td>${item.getStock()}</td>            
                <td><form action="/Module2Project/inventory" method="post">
        ...
        <div><h3>New Product</h3>
            <form action="/Module2Project/inventory" method="post">
                ...
                <p>
                    ...
                    <input type="hidden" name="redirect" value="/Module2Project/inventory"/>
                </p>
            </form>
        </div>
    </body>
